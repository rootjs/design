...
This setter will retrive the \textit{Proxy}, which has been stored in an internal field which is bound to the JavaScript object. The \textit{Proxy} is used to write the new data to the specific memory address, after making sure the property is writable.
